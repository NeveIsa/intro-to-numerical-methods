...
def _(dloss, np, plt, sns):
    ...
    dlossVals = [dloss(t) for t in _x1]
    sns.lineplot(x=_x1, y=dlossVals)
    plt.title(label=f"Derivative of Loss Function: loss(m)")
    return


@app.cell
def _(bisection, np, x, y):
    def loss(m):
